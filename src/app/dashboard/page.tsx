...
export default function Dashboard() {
  ...
  if (!data && loading) return (
    <div style={{ minHeight: '100dvh', background: DARK, display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'rgba(255,255,255,0.3)', fontFamily: 'Inter, sans-serif' }}>
      Cargando...
    </div>
  )

  return (
    <div style={{ minHeight: '100dvh', background: DARK, fontFamily: 'Inter, sans-serif', maxWidth: 480, margin: '0 auto', paddingBottom: 40 }}>
      ...
      <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <input type="date" value={from} onChange={e => setFrom(e.target.value)}
            style={{ flex: 1, padding: '8px 10px', background: '#111', border: '1px solid rgba(212,175,55,0.2)', borderRadius: 8, color: '#fff', fontSize: '0.75rem', fontFamily: 'Inter, sans-serif' }} />
