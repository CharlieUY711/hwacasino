...
export function GameHeader({ title, balance, displayBalance, username, centerContent }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        />
        <span style={{ fontSize: '0.68rem', color: GOLD, fontWeight: 500 }}>
          {title}
        </span>
      </div>
        ...
        {centerContent ?? (
          <>
            ...
            <span style={{ color: GOLD }}>
              {(displayBalance ?? balance).toLocaleString('es-UY')}
            </span>
          </>
        )}
      </div>
