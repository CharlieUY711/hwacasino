# ============================================================
# HWA Casino — Actualizar Ruleta a Multiplayer
# Ejecutar desde la raiz del proyecto (donde esta package.json)
# Actualiza: roulette/page.tsx + roulette/play/page.tsx
# ============================================================

# ============================================================
# 1. src/app/roulette/page.tsx  (Lobby — 3 salas con room param)
# ============================================================
$rouletteLobby = @'
'use client'
...
[System.IO.File]::WriteAllText(
  (Join-Path (Get-Location) "src\app\roulette\page.tsx"),
  $rouletteLobby,
  [System.Text.Encoding]::UTF8
)
Write-Host "OK  src/app/roulette/page.tsx" -ForegroundColor Green

# ============================================================
# 2. src/app/roulette/play/page.tsx  (Mesa — Multiplayer)
# ============================================================
$roulettePlay = @'
'use client'
...
[System.IO.File]::WriteAllText(
  (Join-Path (Get-Location) "src\app\roulette\play\page.tsx"),
  $roulettePlay,
  [System.Text.Encoding]::UTF8
)
Write-Host "OK  src/app/roulette/play/page.tsx" -ForegroundColor Green

Write-Host ""
Write-Host "============================================" -ForegroundColor Cyan
Write-Host " Listo. Archivos actualizados:" -ForegroundColor Cyan
Write-Host "  src/app/roulette/page.tsx       (3 salas, room param)" -ForegroundColor White
Write-Host "  src/app/roulette/play/page.tsx  (multiplayer completo)" -ForegroundColor White
Write-Host ""
Write-Host " Lo que cambia en play/page.tsx:" -ForegroundColor Cyan
Write-Host "  - Polling cada 2s a /api/roulette/round/status" -ForegroundColor White
Write-Host "  - Countdown visible bajo la rueda" -ForegroundColor White
Write-Host "  - Boton APOSTAR (registra apuesta en la ronda)" -ForegroundColor White
Write-Host "  - Mesa bloqueada al apostar o fuera de ventana" -ForegroundColor White
Write-Host "  - Rueda anima automaticamente cuando status=spinning" -ForegroundColor White
Write-Host "  - Payout calculado client-side para mostrar resultado" -ForegroundColor White
Write-Host ""
Write-Host " Siguiente paso: ejecutar el SQL en Supabase" -ForegroundColor Yellow
Write-Host "============================================" -ForegroundColor Cyan
