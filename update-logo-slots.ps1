...
# ─── 1. Copiar logos a public/ ────────────────────────────
New-Item -ItemType Directory -Force -Path "$base\public" | Out-Null
Copy-Item "$logos\Logo HWA Casino rojo.png" "$base\public\logo-rojo.png" -Force
Copy-Item "$logos\Logo HWA Casino blan.png" "$base\public\logo-blanco.png" -Force
Write-Host "Logos copiados." -ForegroundColor Cyan

# ─── 2. layout.tsx con favicon ────────────────────────────
    ...
    <main style={{ minHeight: '100dvh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#000', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{
        ...
        <div className="animate-fade-in delay-200" style={{ marginBottom: '20px' }}>
          <Image src="/logo-rojo.png" alt="HWA Casino" width={140} height={140} style={{ objectFit: 'contain' }} priority />
        </div>
      ...
      <div style={{
        ...
        <div style={{ marginBottom: '24px' }}>
          <Image src="/logo-rojo.png" alt="HWA Casino" width={80} height={80} style={{ objectFit: 'contain' }} />
        </div>
